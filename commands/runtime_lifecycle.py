...
class RuntimeResult:
    ...
    def as_dict(self): return {"schema_version":SCHEMA_VERSION,"command":f"runtime.{self.action}","success":True,"stack":f"stack{self.stack_id}","directory":self.directory,"containers":list(self.containers)}

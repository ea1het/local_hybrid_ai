...
"""Pure helpers for upgrade inventory state and human-readable presentation."""
...
def registry_state(state: upgrade_registry.RegistryState | None) -> tuple[str, dict | None, str | None]:
    if state is None:

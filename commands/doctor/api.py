...
def run_checks():
 ...
 except (install.InstallerError,OSError,subprocess.CalledProcessError) as exc:checks.append(_check("lifecycle_registry","fail","manifest/lifecycle registry validation failed",error=str(exc)))

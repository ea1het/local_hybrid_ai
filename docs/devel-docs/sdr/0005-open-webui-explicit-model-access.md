...
A regular-user qualification must show only `basic_autorouter`; the model must have exactly the intended public read grant. Coverage lives in Stack7 contract tests and the recorded qualification evidence under [`docs/dr/status.md`](../../dr/status.md) and [`docs/pending.md`](../../pending.md).

...
A new stack also declares its recovery semantics under the normalized contract described by [`recovery.schema.json`](../../src/local_ai_cli/restore/recovery.schema.json) and [the DR how-to](../dr/howto.md) before backup/restore behaviour is implemented.

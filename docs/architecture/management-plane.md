...
`commands/recovery/dr.py` owns planning/orchestration and `dr_preflight.py` owns destination/runtime-source preflight. Mutation phases remain separate because their safety properties differ.

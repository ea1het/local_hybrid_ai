...
| `DR-BACKUP-001` | `tests/test_openspec_contracts.py::test_DR_BACKUP_001_stack7_artifact_is_declared` | `tests/dr/test_dr_backup_all.py` |
| `DR-RESTORE-001` | `tests/dr/test_dr_restore_all.py` | qualified clean-target recovery |
...
| `STACK4-GIT-001` | `tests/dr/test_dr_stack4_restore_verify.py` | Gitea backup/restore qualification |
...
| `STACK6-MEMORY-001` | `tests/dr/test_dr_stack6_verify.py` | host Git-memory qualification |

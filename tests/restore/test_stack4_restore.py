...
class Stack4RestoreVerifyTests(unittest.TestCase):
    def test_safe_zip_kind_accepts_regular_file(self):
        ...
        self.assertEqual(stack4_restore_verify.safe_zip_kind(info), "file")
    ...
    def test_safe_extract_rejects_parent_traversal(self):
        with tempfile.TemporaryDirectory() as td:
            ...
            with self.assertRaises(Exception):
                stack4_restore_verify.safe_extract_gitea_dump(archive, destination)
    ...
    def test_find_bare_repositories_requires_repo(self):
        with tempfile.TemporaryDirectory() as td:
            ...
            with self.assertRaises(stack4_restore_verify.Stack4RestoreVerifyError):
                stack4_restore_verify.find_bare_repositories(root)
    ...
    def test_find_bare_repositories_finds_git_dirs(self):
        with tempfile.TemporaryDirectory() as td:
            ...
            found = stack4_restore_verify.find_bare_repositories(root)

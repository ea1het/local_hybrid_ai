...
class Stack4RestoreVerifyTests(unittest.TestCase):
    ...
    def test_restore_sqlite_imports_tables_and_data(self):
        with tempfile.TemporaryDirectory() as td:
            ...
            tables, nonempty = stack4_restore_verify.restore_sqlite(sql, root / "restored.db")
    ...
    def test_safe_extract_rejects_parent_traversal(self):
        with tempfile.TemporaryDirectory() as td:
            ...
            with self.assertRaises(Exception):
                stack4_restore_verify.safe_extract_gitea_dump(archive, target)
    ...
    def test_find_bare_repositories(self):
        with tempfile.TemporaryDirectory() as td:
            ...
            found = stack4_restore_verify.find_bare_repositories(repos)
            self.assertEqual(found, [repo])

    def test_result_never_claims_live_modification(self):
        result = stack4_restore_verify.RestoreVerification(

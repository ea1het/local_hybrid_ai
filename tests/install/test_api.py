...
from commands.install import api,engine
class InstallApiTests(unittest.TestCase):
 ...
 def test_package_is_self_contained(self):
  self.assertEqual(api.engine.__name__,"commands.install.engine");self.assertNotIn("commands.installer",api.__dict__.values())

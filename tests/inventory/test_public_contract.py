...
class InventoryPublicContractTests(unittest.TestCase):
 ...
 def test_inventory_uses_private_component_implementation(self):self.assertEqual(inventory.api.component_inventory.__name__,"local_ai_cli.inventory._component_inventory")

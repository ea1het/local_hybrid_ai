    ...
    def test_registry_tags_preserve_rate_limit_and_auth_failures(self):
        for status, expected in ((429, "rate_limited"), (401, "unauthorized"), (403, "forbidden")):
            with (
                ...
                mock.patch("local_ai_cli.upgrade._registry._registry_request", return_value=(status, {}, b"")),
            ):
    ...
    def test_inventory_never_renders_registry_failure_as_current(self):
        ...
        for status in ("rate_limited", "unauthorized", "forbidden"):
            ...
            with (
                ...
                mock.patch.object(upgrade, "component_records", return_value={"stack1/haproxy": record}),
                ...
                mock.patch.object(upgrade, "running_image", return_value="haproxy:3.0-alpine"),
                mock.patch.object(upgrade.upgrade_registry, "inspect", return_value=state),
            ):

...
class RepositoryLayoutTests(unittest.TestCase):
    ...
    def test_local_ai_is_the_supported_root_management_cli(self):
        ...
        self.assertTrue((commands / "component_inventory.py").is_file())
        self.assertTrue((commands / "inventory.py").is_file())
        self.assertFalse((commands / "upgrade-components.json").exists())
